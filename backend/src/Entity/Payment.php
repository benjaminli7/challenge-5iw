...
use App\Controller\PaymentConfirmationController;
...
#[ApiResource(
    operations: [
        ...
        new Post(
            uriTemplate: '/payments/handle-payment-success',
            controller:PaymentConfirmationController::class,
            openapiContext: [
                'summary' => 'Crée un paiement',
